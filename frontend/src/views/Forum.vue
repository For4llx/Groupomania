            ...
            <section class="main__section">
                ...
                <div class="main__containerMessage">   
                    <div class="main__profile">
                        <img class="main__picture" src="../assets/profilePicture.png" alt="Photo de profil" />
                        <div class="main__content">
                            <p class="main__fullName">Nom complet</p>
                        </div>
                    </div>
                ...
                <input class="main__input" placeholder="Exprimez vous ici !">
            </section>
