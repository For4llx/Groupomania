  ...
  <div id="signupForm">
      ...
      <nav class="navigation">
        <ul class="navigation__unorderedList">
          <li class="navigation__bullet">
            <router-link class="navigation__button" to="/signup"
              >Inscription</router-link
            >
          </li>
          <li class="navigation__bullet">
            <router-link class="navigation__button" to="/"
    ...
    <section class="formSection">
      ...
      <form class="formSection__form">
        <div class="formSection__containerDoubleInput">
          <input
            v-model="lastName"
            class="formSection__input formSection__input--small"
            type="text"
            placeholder="Nom"
          />
          <input
        ...
        />
        <button @click.prevent="submitForm()" class="formSection__button">
          Inscription
        </button>
      </form>
    </section>
